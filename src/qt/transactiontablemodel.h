...
private:
    ...
    QString formatTxAmount(const TransactionRecord *wtx, bool showUnconfirmed=true, TROISUnits::SeparatorStyle separators=TROISUnits::SeparatorStyle::STANDARD) const;

// Copyright (c) 2018-2020 The TROIS Core developers
...
//! Entry point for TROISApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &TROISApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for TROISGUI tests.
void AppTests::guiTests(TROISGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &TROISGUI::consoleShown, this, &AppTests::consoleTests);

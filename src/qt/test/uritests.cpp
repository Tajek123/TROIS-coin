// Copyright (c) 2009-2018 The TROIS Core developers
...
void URITests::uriTests()
{
    ...
    QVERIFY(!GUIUtil::parseTROISURI(uri, &rv));
    ...
    QVERIFY(GUIUtil::parseTROISURI("bitcoin:175tWpb8K1S7NmH4Zx6rewF9WQrcZv245W?message=Wikipedia Example Address", &rv));
    QVERIFY(rv.address == QString("175tWpb8K1S7NmH4Zx6rewF9WQrcZv245W"));
    QVERIFY(rv.label == QString());

// Copyright (c) 2015-2020 The TROIS Core developers
...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<TROISAmountField*>("payAmount")->setValue(amount);
...
void TestGUI(interfaces::Node& node)
{
...

    {
        ...
        QString balanceComparison = TROISUnits::formatWithUnit(unit, balance, false, TROISUnits::SeparatorStyle::ALWAYS);
    ...
    // Amount input
    TROISAmountField* amountInput = receiveCoinsDialog.findChild<TROISAmountField*>("reqAmount");

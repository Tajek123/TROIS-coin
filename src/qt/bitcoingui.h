...
/**
  TROIS GUI main class. This class represents the main window of the TROIS UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class TROISGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit TROISGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = nullptr);
    ~TROISGUI();
...
public Q_SLOTS:
    ...
    /** Load Partially Signed TROIS Transaction from file or clipboard */

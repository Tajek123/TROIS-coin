This directory contains the source code for the TROIS Core graphical user interface (GUI). It uses the [Qt](https://www1.qt.io/developers/) cross-platform framework.
...
- Represents the main window of the TROIS UI.
...
* UI elements like TROISAmountField, which inherit from QWidget.
* `bitcoinstrings.cpp`: automatically generated
* `bitcoinunits.(h/cpp)`: ISC / mISC / etc. handling
* `callback.h`
...
9. You're all set! Start developing, building, and debugging the TROIS Core GUI

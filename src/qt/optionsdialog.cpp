    ...
    mapper(nullptr)
{
    ...
    ui->openTROISConfButton->setToolTip(ui->openTROISConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new TROISUnits(this));
...
void OptionsDialog::on_openTROISConfButton_clicked()
{

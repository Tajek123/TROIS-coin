...
// ----------------------------------------------------------------
// TROIS COIN (ISC) - Custom Sovereign Chain
// Developer: Taj Pocrnja Zupan
// Hardware: ASUS G53J (Intel i5-460M, 4GB RAM)
// OS: Ubuntu Server 24.04 LTS (Running Bitcoin Core v22)
// Timestamp: December 2025
// Note: "ASUS looked beastly, but single-core performance is the only truth."
// ----------------------------------------------------------------
...
public:
    CMainParams() {
        ...
        // genesis = CreateGenesisBlock(1231006505, 2083236893, 0x1d00ffff, 1, 50 * COIN); // Old Line (Commented out)
// Use CURRENT time (approx), 0 nonce, same difficulty
genesis = CreateGenesisBlock(1764160718, 1247245258, 0x1d00ffff, 1, 10000 * COIN);
// START GENESIS MINING
        consensus.hashGenesisBlock = genesis.GetHash();
        
        // END GENESIS MINING
        consensus.hashGenesisBlock = genesis.GetHash();
assert(consensus.hashGenesisBlock == uint256S("0x000000001de5e776e4a7ef71d21bf62b0ab1f371db82205868bbf3c0c11d6795"));
assert(genesis.hashMerkleRoot == uint256S("0x9ec80b983510751421cc0ed399c4699f4d043007940d7fbcec2de3178b961b54"));
